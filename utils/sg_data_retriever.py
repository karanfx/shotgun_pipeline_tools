...
class ShotgunDataRetriever:
    ...
    def get_assets(self, project_id=None, sequence_id=None, shot_id=None):
        ...
        asset_fields = ["id", "code", "description"]  # Add more fields as needed
...
if __name__ == "__main__":
    # Usage
    site_url = "https://testvfx.shotgrid.autodesk.com"
    script_name = "testscript"
    script_key = "byjzbl-abBmd3ohtpebhjkadu"

    data_retriever = ShotgunDataRetriever(site_url, script_name, script_key)
